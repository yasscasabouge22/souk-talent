      ...
      <div className="container mx-auto px-4">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-400">{selectedCategory !== "Tous" || selectedRegion !== "Toutes les régions" || searchQuery ? "Essayez de modifier vos critères de recherche" : "Aucun artiste inscrit pour le moment."}</p>
            {(selectedCategory !== "Tous" || selectedRegion !== "Toutes les régions" || searchQuery) && (
              <Button onClick={() => { setSelectedCategory("Tous"); setSelectedRegion("Toutes les régions"); setSearchQuery(""); }} className="mt-4 bg-[#1DB954] text-black">Réinitialiser les filtres</Button>
            )}
          </div>
        ) : (
        ...
        <div className="flex items-start justify-between mb-2">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              {artist.is_verified && <BadgeCheck className="size-4 text-[#1DB954] fill-[#1DB954]" />}
